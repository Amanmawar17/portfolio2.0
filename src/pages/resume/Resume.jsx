...
function Card(value) {
  ...
  return (
    <div
      key={id}
      className="grid lg:grid-flow-col grid-flow-row place-content-center gap-4 lg:gap-20 max-w-sm lg:max-w-3xl px-6 py-10 rounded-sm dark:bg-accentwhite dark:text-black shadow-2xl dark:shadow-sm"
    >
      <div>
    ...
    <section id="resume" className="py-8 min-h-[82vh]">
      <div className="flex justify-center flex-col">
        <div className="flex justify-start lg:justify-center items-center p-3">
          <h1 className="text-5xl text-primary dark:text-accentwhite font-semibold">
            Resume
          </h1>
          <button className="inline absolute right-3 rounded-sm bg-secondary text-base10 hover:bg-secondary/80 p-2">
            Download CV
          </button>
        </div>
