        ...
        <div className="flex justify-evenly flex-col-reverse lg:flex-row items-center font-mono">
          <div className="flex-col max-w-lg lg:w-1/2">
            ...
            <h4
              ...
              id="animate-text"
            >I`m a <span className="text-primary">
            ...
            <div className="flex justify-start font-semibold py-3">
              <a href="#resume" className="mx-2">
                <button className="outline outline-2 outline-primary rounded-xl bg-primary text-base10 hover:bg-base10 hover:text-primary p-2">
                  Resume
                </button>
              </a>
              <a href="#project" className="mx-2 ease-in">
                <button className="outline-2 outline outline-secondary rounded-xl bg-white text-secondary hover:bg-secondary hover:text-base10 p-2">
                  Projects
                </button>
              </a>
            </div>
          ...
          <div id="hero" className="flex justify-center flex-col items-center">
            <Tilt
              ...
              glareMaxOpacity={0.5}
            >
              <div className="text-center w-full float-end">
                <img
                ...
                <div className="flex justify-evenly items-center my-3 max-w-xs mx-auto">
                  <a href="https://github.com/Amanmawar17" target="_blank">
                    <FaGithub className="text-secondary h-6 w-6" />
                  </a>
                  <a
                  ...
                  <a href="https://twitter.com/aman_mawar" target="blank">
                    <FaXTwitter className="text-secondary h-6 w-6" />
                  </a>
                </div>
              </div>
            </Tilt>
