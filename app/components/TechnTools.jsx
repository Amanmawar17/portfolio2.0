...
function TechnTools() {
  return (
    <div className="pt-10 pb-20 grid max-w-sm md:max-w-lg lg:max-w-6xl m-auto">
      ...
      <ul className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-9 gap-4 place-items-center mt-8">
